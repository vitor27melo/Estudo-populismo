...
FOLDER = "C:/Users/Vitor/Documents/Faculdade/FLP0472 - Governo Representativo/FLP0472-Artigo/arquivos/extracted_TXT/Lula"
...
for ano in anos:
    ...
    if(ano[-1] == 't'):
        continue
    relatorio_file = open(ano + "/Relatorio.txt", "r")
    relatorio_string = ""
    lines = relatorio_file.readlines()
    for line in lines:
        if '"' in line:
            continue
        relatorio_string = relatorio_string + line
    ...
    analise = open(ano + "/Analise.txt", "w")
